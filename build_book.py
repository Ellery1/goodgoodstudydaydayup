...
FIGURE_META = {
    ...
    "荀子（约前313-前238年）":     ("荀子",         "约前313-前238年", -313, ["坚持", "积累", "学习"]),
    "屈原（约前340-前278）":       ("屈原",         "约前340-前278年", -340, ["气节", "孤独", "家国"]),

    # ── 中国 · 两汉 ──
    "司马迁（前145年-前86年）":    ("司马迁",       "前145年-前86年",  -145, ["坚持", "突破", "传承", "勇气"]),
    "张骞（前164年-前114年）":     ("张骞",         "前164年-前114年", -164, ["探索", "坚持", "开拓"]),
    "苏武（前140年-前60年）":      ("苏武",         "前140年-前60年",  -140, ["气节", "坚守", "孤独"]),
    "班超（32-102年）":            ("班超",         "32-102年",         32, ["开拓", "勇气", "投笔从戎"]),
    "张衡（78-139年）":            ("张衡",         "78-139年",         78, ["创新", "博学", "探索"]),
    "陆绩（187-219年）":           ("陆绩",         "187-219年",       187, ["孝道", "学识"]),

    # ── 中国 · 魏晋南北朝 ──
    "阮籍（210-263年）":           ("阮籍",         "210-263年",       210, ["孤独", "智慧", "隐忍"]),
    "羊祜（221-278年）":           ("羊祜",         "221-278年",       221, ["胸怀", "气度"]),
    "嵇康（223-262年）":           ("嵇康",         "223-262年",       223, ["气节", "孤独", "选择"]),
